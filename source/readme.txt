...
To build Clipboard.pll, you need:

	- the Perl5 source

The two makefiles are:
	CLIPBOARD.MAK    for Perl-Win32 version 5.001 (build 110)
	CLIPBOARD300.MAK for Perl-Win32 version 5.003 (build 300 and higher)

You have to place the content of this directory in:

	(perl5)\dll-src\ext\win32\clipboard (for version 5.001) 
or
        (perl5)\ext\win32\clipboard         (for version 5.003)
